[Mesh]
  type = GeneratedMesh
  dim = 2
  nx = 200 #'${fparse int ( 2 * xmax / ${GlobalParams/int_width} ) }'
  ny = 100
  xmin = 0
  xmax = 10
  ymin = 0
...
[AuxKernels]
  ...
  #   component = 'x'
  #   diffusivity = D
  #   diffusion_variable = c_v
  # []

  #Taking the gradient of the flux vector
  # [grad_flux_x_v]
  ...
  #   type = ParsedAux
  #   variable = s0_aux
  #   coupled_variables = 's11_aux s22_aux'
  #   expression = 's11_aux+s22_aux'
  # []
[]
...
[Materials]
  ...
  [neumann_source_left_x] # +ve for entering
    type = ParsedMaterial
    expression = '1e-5' 
  ...
  #   property_name = M_v
  #   coupled_variables = 'c_v'
  #   material_property_names = 'kB T D chi_v'
  #   expression = 'D*chi_v' # nm^2/(eV.K.s)
  # []
  # [diffusivity]
