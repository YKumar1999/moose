...
[Materials]
  ...
  [diffuse_strain_increment]
    ...
    output_properties = 'diffuse_strain flux_trace flux_tensor flux_shear flux_total flux_volume'
    outputs = 'exodus'
  []
...
[Outputs]
  exodus = true
  checkpoint = true
  file_base = 2D_Scalar_Square_FluxBasedAccumulation_WithCorrection
[]
