...
#Testing the file with RZ axisymmetric 
...
[Materials]
  ...
  [diffuse_strain_increment]
    ...
    output_properties = 'diffuse_strain flux_tensor flux_total flux_shear flux_volume flux_trace flux_transpose'
    outputs = 'exodus'
  []
...
[Outputs]
  exodus = true
  checkpoint = true
  file_base = 2D_Scalar_Square_NBC_BothSource_RZ_Test
[]
