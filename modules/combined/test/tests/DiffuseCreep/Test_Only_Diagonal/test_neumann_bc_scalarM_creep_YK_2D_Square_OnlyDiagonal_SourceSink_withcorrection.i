...
[Materials]
 ...
 [neumann_source_top_y] # +ve for entering
  ...
  [diffuse_strain_increment]
    ...
    output_properties = 'diffuse_strain flux_trace flux_tensor flux_shear flux_total flux_volume flux_transpose'
    outputs = 'exodus'
  []
...
[Outputs]
  exodus = true
  checkpoint = true
  file_base = 2D_Scalar_Square_Diagonal_NBC_SourceSink_withcorrection
[]
