...
[Materials]
  ...
  [diffuse_strain_increment]
    ...
    output_properties = 'diffuse_strain flux_tensor flux_total flux_shear flux_volum flux_trace flux_transpose flux_identity'
    outputs = 'exodus'
  []
...
[Outputs]
  exodus = true
  checkpoint = true
  file_base = 2D_Scalar_Square_BothSource_withcorrection_new
[]
