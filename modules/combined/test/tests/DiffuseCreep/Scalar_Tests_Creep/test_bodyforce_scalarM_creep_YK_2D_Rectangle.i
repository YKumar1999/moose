...
[ICs]
  ...
  #   outside = 0
  #   int_width = 0.5
  #   larger_coordinate_corners = '5 5 0 10 5 0'
  #   smaller_coordinate_corners = '3 0 0 9 0 0'
  #   variable = u
  # [../]
  [./MaskingCondition1]
    ...
    outside = 0
    int_width = 0.5
    larger_coordinate_corners = '5 5 0'
    smaller_coordinate_corners = '3 0 0'
    variable = u
  [../]
  #   [./MaskingCondition2]
  #   type = NestedBoundingBoxIC
  ...
  #   outside = 0
  #   int_width = 0.5
  #   larger_coordinate_corners = '10 5 0'
  #   smaller_coordinate_corners = '9 0 0'
  #   variable = v
  # [../]
[]
...
[Materials]
  ...
  [diffuse_strain_increment]
    ...
    flux_volume_name = flux_volume
    flux_identity_name = flux_identity
    property_name = diffuse_strain
    flux_Antisymmetric_name = flux_antisymmetric
    output_properties = 'diffuse_strain flux_tensor flux_total flux_shear flux_volume flux_trace flux_transpose flux_identity flux_antisymmetric'
    outputs = 'exodus'
  []
...
[Outputs]
  exodus = true
  checkpoint = true
  file_base = 2D_Scalar_Rectangle_Bodyforce
[]
