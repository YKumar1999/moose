...
[Materials]
  ...
  [diffuse_strain_increment]
    ...
    Source = source
    output_properties = 'diffuse_strain flux_tensor flux_total flux_shear flux_transpose flux_identity flux_derivativeconc flux_deviotoric_localC'
    outputs = 'exodus'
  []
...
[Outputs]
  exodus = true
  checkpoint = true
  file_base = 2D_Scalar_Square_Bodyforce_withcorrection_NonUniform_Lambda1_RemovedBC_Chakraborty_RemovedSource_CircularGrain_Explicit_onlyJ_new
[]
